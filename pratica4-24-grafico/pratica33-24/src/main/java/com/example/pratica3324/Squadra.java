...
public class Squadra {
    ...
    private static int indexInseriti;
    ...
    public static void setSquadra(Giocatore[] squadra) { Squadra.squadra = squadra; }
    public static int getIndexInseriti() { return indexInseriti; }
    public static void setIndexInseriti(int indexInseriti) { Squadra.indexInseriti = indexInseriti; }
